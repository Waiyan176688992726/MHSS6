...
prinCP=[]
try:
    prox= requests.get('https://github.com/Waiyan176688992726/Apppppp66/blob/main/Appp678.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Waiyan176688992726/Apppppp66/blob/main/Appp678.txt').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Waiyan176688992726/Apppppp66/blob/main/Appp678.txt').text
    if id in httpCaht:
      print(fuckyoursali)
